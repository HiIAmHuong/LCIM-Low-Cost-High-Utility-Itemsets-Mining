...
/**
 * Example of how to run batch experiments with the holdout
 * @author Philippe Fournier-Viger, 2020
 *
 */
public class MainTestEVALUATOR_Holdout {

	
	public static void main(String[] args) throws Exception {

		// The target attribute
		String targetClassName = "Churn";
...
//		ARFFDataset dataset = new ARFFDataset(datasetPath, targetClassName);
		...
		String datasetPath = fileToPath("TelcoCustomerChurnCSV.txt");
...
//		ClassificationAlgorithm algorithmCPAR = new AlgoCPAR(deltaCPAR,minBestGain, alpha, k);
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestEVALUATOR_Holdout.class.getResource(filename);
